...
const messages ={
   ru:{
      ...
      {  
         ...
         minValueRequired:'Нужно выбрать операцию',
         minLength:'Значение должно содержать не мение {min} символов',
         maxLength:'Значение должно содержать не более {max} символов',
         minValue:'Значение должно быть не менее {min} символов',
         maxValue:'Значение должно быть не более {max} символов',
         ...
         ipAddress:'Неверный формать IP-адреса',
         macAddress:'Неверный формат MAC-адреса',
         sameAs:'Знаения не идентичны',
